 ...
 * @author HuynhBao
 */
@WebServlet(name = "AdminManageProductsController", urlPatterns = {"/AdminManageProductsController"})
public class AdminManageProductsController extends HttpServlet {

    private static final String ERROR = "invalid.jsp";
    private static final String SUCCESS = "manage-products.jsp";

    private static final Logger LOGGER = Logger.getLogger(AdminManageProductsController.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user == null) {
                ...
                Map<Integer, List<ProductDTO>> list = dao.getProducts(currentPage);
                ...
                request.setAttribute("LIST", list.get(rows));
                url = SUCCESS;
            }
